...
function create({ name, directory, mode }) {
  ...
  // escape-time 0: tmux default is 500ms wait after ESC before deciding if it's
  // a standalone Escape or start of an escape sequence (arrow keys etc). Zero = instant.
  // default-terminal: ensures correct key translation between xterm.js and pane apps.
