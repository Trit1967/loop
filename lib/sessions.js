...
function create({ name, directory, mode }) {
  ...
  // When the client attaches, xterm.js will have enough scrollback to
  // scrollToBottom() and show the prompt in the lower portion of the viewport.
  exec(`tmux send-keys -t '${escapedName}' 'printf "\\n%.0s" {1..60}' Enter`);
